...
# match lines:   "file:lineno:content" (colon separator)
# context lines: "file-lineno-content" (dash separator)
# On Windows, paths contain drive letters (e.g. C:\path), so naive split(":") breaks.
