...
class SessionDB(SessionSearchMixin, SessionSchemaMixin, SessionPortabilityMixin):
    ...
    def sanitize_title(title: Optional[str]) -> Optional[str]:
        ...
        # ⚡ Bolt: Consolidated two sequential re.sub calls into a single compiled regex
        # replacement to avoid redundant string allocations and context switches during sanitization.
        # This single pattern matches both ASCII control chars (0x00-0x1F, 0x7F except \t, \n, \r)
        # and problematic Unicode control chars (zero-width, directional overrides, etc.).
        cleaned = re.sub(
