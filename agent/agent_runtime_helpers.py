...
_STRIP_XML_BLOCKS_RE = re.compile(
    r'<(think|thinking|reasoning|REASONING_SCRATCHPAD|thought|tool_call|tool_calls|tool_result|function_call|function_calls)\b[^>]*>.*?</\1>',
...
def strip_think_blocks(agent, content: str) -> str:
    ...
    content = _STRIP_XML_BLOCKS_RE.sub('', content)
